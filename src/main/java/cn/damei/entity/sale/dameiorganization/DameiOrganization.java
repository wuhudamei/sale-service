package cn.damei.entity.sale.dameiorganization;
...
public class DameiOrganization extends IdEntity {
    ...
    public static OrganizationTreeDto buildOrganizationTree(OrganizationTreeDto curCode, List<DameiOrganization> orgList) {
    ...
    public static OrganizationTreeDto buildOrgTreeWithJob(OrganizationTreeDto curCode,
                                                          List<DameiOrganization> orgList, User user) {
