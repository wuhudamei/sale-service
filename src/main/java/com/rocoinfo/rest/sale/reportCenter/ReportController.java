package com.rocoinfo.rest.sale.reportCenter;
...
import com.rocoinfo.service.sale.report.ReportNissinService;
...
/**
 * <dl>
 * <dd>Description: 美得你售后  工单统计报表接口 controller</dd>
 * <dd>@date：2017-10-9 15:55:02</dd>
 * <dd>@author：Ryze</dd>
 * </dl>
 */
@RestController
...
public class ReportController extends BaseController {
    ...
    /**
     * @author Ryze
     * @date 2017/10/17 15:06
     * @description 部门日清报表需要的 售后门店
     * @param
     * @return
     */
    ...
    public Object depReport(@RequestParam(value = "companyId") String companyId,
        ...
        Map<String, Object> params = Maps.newHashMapWithExpectedSize(1);
        params.put(COMPANY_ID, Integer.valueOf(companyId).intValue());
        List<MdniOrganization> company = mdniOrganizationService.findCompany(Integer.valueOf(companyId));
