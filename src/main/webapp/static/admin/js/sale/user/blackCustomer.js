    ...
    vueIndex = new Vue({
        ...
        methods: {
            ...
            drawTable: function () {
                ...
                self.$dataTable = $(this.$els.dataTable).bootstrapTable({
                    ...
                    queryParams: function (params) {
                        ...
                        var data = {
                            ...
                            //如果是98,说明是集团公司,就给null
                            companyId: self.form.companyId == 98 ? null : self.form.companyId,
                            //黑名单标记
                            blackFlag: true
                        };
                        // 将table 参数与搜索表单参数合并
                    ...
                    columns: [{
                        ...
                        formatter:function(value,row){
                            ...
                            width: '5%',
                            formatter: function(value,row){
                                return '<button data-handle="recover-customer" style="margin-left:15px;" ' +
                                    'class="btn btn-xs btn-danger" data-id="' + row.id + '" type="button">恢复</button>';
                            }
                        }]
                });
                ...
                //恢复 取消黑名单标记
                self.$dataTable.on('click','[data-handle="recover-customer"]',function(e){
                    var id = $(this).data('id');
                    swal({
                            title: '取消无需回访客户标记',
                            text: '是否给该客户取消无需回访标记?',
       ...
       var arr = [{
		           ...
		           formatter: function(value,row){
		        	   ...
		        	   return '<a href="/workorder/workOrderInfo?workOrderId='+ row.id 
          				+'&firstId=customerMenu&secondId=groupCustomer" >' + value + '</a>';
		           }
		       }, {
		           field: 'customerMobile',
		           title: '客户电话',
