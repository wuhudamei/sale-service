            ...
            drawTable: function () {
                ...
                self.$dataTable = $(this.$els.dataTable).bootstrapTable({
                    ...
                    queryParams: function (params) {
                        // 将table 参数与搜索表单参数合并
                        return _.extend({'orderStatus': 'FAILUREVISIT'}, params, self.form);
                    },
                    ...
                    columns: [{
                        ...
                        formatter: function(value,row){
                        	return '<a onclick="vueIndex.storeParams()" href="/workorder/workOrderInfo?workOrderId='+ row.id
                        		+'&firstId=workOrderVisit&secondId=unsuccessful" >' + value + '</a>';
                        ...
                        align: 'center',
                        formatter: function(value,row){
                        	return '<a onclick="vueIndex.storeParams()" href="/workorder/visit?source=failureVisit&orderStatus='+ row.orderStatus +'&workOrderId='+ row.id
