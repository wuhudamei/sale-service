    ...
    <form v-on:submit.prevent="submit" role="form">
      <div class="form-group">
        <input
          ...
          id="username" name="username" type="text" value="admin" class="form-control" placeholder="请输入用户名" required="">
      </div>
      <div class="form-group">
        <input
          v-model="form.password"
          type="password" class="form-control" value="admin" placeholder="请输入密码" required="">
      </div>
...
<script src="/static/admin/js/wx/login/login.js"></script>
</body>
</html>
