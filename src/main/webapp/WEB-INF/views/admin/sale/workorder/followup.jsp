...
<body id="app" class="fixed-sidebar full-height-layout gray-bg">
                                    ...
                                    <validator name="validation">
                                        <form id="searchForm" class="form-horizontal" @submit.prevent="query">
                                            ...
                                            <div class="modal-center ">
                                                <button @click="finishOrder" :disabled="submitting" type="button"
                                                class="btn btn-success">工单完成
                                                </button>
                                                &nbsp;
    ...
    <script src="/static/admin/js/sale/workorder/followup.js"></script>
</body>
</html>