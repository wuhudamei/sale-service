					...
					<form id="searchForm" @submit.prevent="query">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <select v-model="form.orderStatus"
                                        ...
                                        <option value="CREATE" >未派单</option>
                                        <option value="RECEIVED" >已接收</option>
                                        <option value="PROCESSING" >处理中</option>
                                        <option value="REFUSED" >申诉</option>
                                        <option value="REFUSEDAGAIN" >申诉无效</option>
                                        <!-- <option value="PENDING" >待处理</option> -->
                                        <option value="SATISFIED" >回访满意</option>
                                        <option value="COMMONLY" >一般</option>
                                        <option value="UNSATISFIED" >回访不满意</option>
                                        <option value="INVALIDVISIT" >暂无评价</option>
                                        <option value="FAILUREVISIT" >不再回访</option>
                                        <option value="ASSIGN" >待分配</option>
                                        <!-- <option value="URGE" >催单</option> -->
                                        <!-- <option value="NREPLY" >待回复</option>
                                        <option value="NVISIT" >待回访</option> -->
                                        <option value="CONSULTOVER" >咨询完毕</option>
                                        <!-- <option value="UNEXECUTED" >回访未执行</option> -->
                                        <option value="COMPLETED" >已完成</option>
                                        <option value="INVALIDITY" >无效工单</option>
                                    </select>
                                </div>
                            </div>
                    	...
                    	<div class="row">
                            ...
                            <div class="col-md-2 text-center">
                                <div class="form-group">
                                    <label for="createDate" style="line-height: 34px;cursor:pointer;">
                                        <input
                                            v-model="form.createDate"
                                            id="createDate"
                                            name="createDate" type="checkbox"/>
                                   	        &nbsp;&nbsp;发起时间
                                    </label>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    <input
                                            ...
                                            id="createUserName" name="createUserName"
                                            type="text" class="datepicker form-control"
                                            placeholder="工单发起人"/>
                                </div>
                            </div>
                            ...
                            <!-- 导出-->
                            <shiro:hasPermission name="workorderFromStore:export">
                                <div class="col-md-1">
                                    <div class="form-group">
...
<script src="/static/admin/js/sale/workorder/storeWorkOrderList.js"></script>
</body>
</html>